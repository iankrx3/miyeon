...
-- Places a signed-in user pinned (guest saves stay in localStorage).
...
-- Manually built trips for any signed-in user (not curators).
-- id is text so client-generated `itn_…` keys round-trip without remapping.
