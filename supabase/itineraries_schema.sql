...
-- User saves (saved_places / saved_itineraries / user_itineraries) live in
-- supabase/user_saves_schema.sql — apply that file separately. They used to be
-- duplicated here, which made re-runs fail on create policy.