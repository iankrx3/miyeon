...
/** Rough travel mode + minutes for a straight-line distance (walk / subway / taxi). */
export function travelForDistance(km: number): { mode: TravelMode; minutes: number } {
...
export function travelBetween(a: Spot, b: Spot): { mode: TravelMode; minutes: number } {
  return travelForDistance(haversineKm(a, b));
}
